...
class GUI(QWidget):
    ...
    def obliczanie(self): 
        ...
        try:
            ...
            if (wspolczynnik_tarcia < 0):
                QMessageBox.warning(self, "Błąd", "Współczynnik tarcia nie może być ujemny")
            elif (wspolczynnik_tarcia > 1.0):
    ...
    def randomF(self):
        ...
        wspolczynnik_tarcia = float(random.choice([0.1, 1.0]))
